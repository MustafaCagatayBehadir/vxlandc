...
def create_description(port, port_parameters):
...
def create_po_member_description(node_port, port_parameters):
...
def get_vpc_nodes(port):
    ...
    """
    site = port._parent._parent._parent._parent._parent._parent
...
def is_node_vpc(port, port_parameters):
